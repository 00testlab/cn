...
void main()
{
	...
	printf("Enter the four bits of data one by one\n");
	scanf("%d",&data[0]);
	scanf("%d",&data[1]);
	scanf("%d",&data[2]);
	scanf("%d",&data[3]);
	...
	c1 = datarec[6]^datarec[3]^datarec[2]^datarec[0];
	c2 = datarec[5]^datarec[3]^datarec[1]^datarec[0];
	c3 = datarec[4]^datarec[2]^datarec[1]^datarec[0];
